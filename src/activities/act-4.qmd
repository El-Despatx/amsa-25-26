...
Okay, now that we understand the architecture we’ll be building, the next steps are as follows:
  ...
  3) Upload your container image to the ECR Registry.
  4) Create a Task Definition for our ECS.
  5) Create a Task with the definition we configured on step 3.

Let's se them step by step.

##### Login to AWS academy and start the lab
...
##### Upload your container image to the ECR
...
##### Create a Task Definition for our ECS.

- The launch type should be `fargate`, for [having a true serverless service](/weeks/week-12.html#serverless)
...
##### Create a Task from our definition
