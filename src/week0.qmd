...
<img src="figures/week0/crabs.png" style="width:50%;"/>
:::
...
## Pace of the labs (Weeks 0 → 8) {.smaller}
...
## Pace of the labs (Weeks 9 → 17) {.smaller}

| Week      | Contents                                          |
| --------- | ------------------------------------------------- |
| **9**     | 🖥️ **Virtualization & Containers** intro         |
| **10**    | 📖 Explain **PRAC-4.1**                           |
| **11**    | 📖 Explain **PRAC-4.2** ➝ 📤 Deliver **PRAC-4.1** |
| **12**    | ☁️ **AWS Intro** ➝ 📤 Deliver **PRAC-4.2**        |
| **13**    | 📖 Explain **PRAC-4.3**                           |
...
<!-- Note: No recuparables

Note: Percentatges de lo que conten (10% pracs i 45 45 examens, on el 25 de cada un anira sobre la practica) -->
