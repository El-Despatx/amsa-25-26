...
As a summary, is a tool that formats the code according to the python standard. For this course, we’ll use [Ruff](github.com/astral-sh/ruff) as a linter because:
