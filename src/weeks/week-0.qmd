...
-   Visit the subject lab's [website](amsa.lol), there you'll find a **link to download** a Virtual Machine under the **Resources** section. It will download a `.ova` file.
...
We will be using [**GitHub Classroom**](classroom.github.com) to deliver and evaluate all activities.
