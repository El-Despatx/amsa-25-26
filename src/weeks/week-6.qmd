---
subtitle: "Week 6: Users, permissions and quotas"
format: revealjs
---
...
# Add to 'docker' group (if desired)
...
# 3) Enable ext4 quota feature
sudo tune2fs -O quota /var/lib/amsa/quota_disk

# 4) Create mount point
sudo mkdir -p /mnt/quota

# 5) Mount with quotas enabled
