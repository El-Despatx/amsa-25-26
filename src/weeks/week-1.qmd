...
## Bootloader
Explain what is, Loads the version of the Kernel that you choose inside ram, and follows the "contract" that it has with the linux kernel.

## Kernel
Explain that's only a program, what it does, etc, etc. We'll explain a little bit more about the kernel in the following sessions, but for today, for watching what the kernel does
...
⚠️ The real kernel implementation is more complex (concurrency, performance, real C code, etc.). If you're curious or bored, you can read it here: https://elixir.bootlin.com/linux/v6.16.3/source/kernel/printk/printk.c
:::
:::::::
