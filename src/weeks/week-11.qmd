...
<img src="figures/week-11/docker-network.png" style="width:100%;"/>
:::
::: {.column .fragment width="50%"}
Using Docker Compose:
<img src="figures/week-11/compose-network.png" style="width:100%;"/>
:::
::::
...
## Volumes and bind mounts {.smaller}
...
::: callout-tip
There's something called named volumes as well, which are managed by Docker and not tied to a specific host directory, usually better for production environments.
Feel free to check them out in the references!
:::
