...
-   [Playing an EFI made tetris](weeks/week-1.qmd#extra)
-   [Create your own syscall](weeks/week-2.qmd#extra)
-   [Implement your own `nice` in python](weeks/week-3.qmd#extra)
-   [Modify handlers and implement `nohup` in python](weeks/week-4.qmd#extra)
