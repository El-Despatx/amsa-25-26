...
This depends on your linux distribution (or, if you’re on Windows, your questionable operating system), [read the official documentation for installing it](https://docs.aws.amazon.com/cli/latest/userguide/getting-started-install.html).
