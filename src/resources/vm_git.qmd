...
This page covers how to set up Virtualbox with the subject's OVA and a brief on Git's basics
...
2. __Reinstall Virtualbox completely__
:::
...
:::
### Non-silicon (Linux/Windows users)
...
### Silicon (MAC MX users)
__UNDER CONSTRUCTION__
<!-- Download the image from [this link]() and double-click it to import the box. -->
<!-- User `amsa` and password `amsa` -->
...
The first step will be to create an SSH key on your machien to authenticate to Github and be able to interact with it. For this, you can follow [Github's guide](https://docs.github.com/en/authentication/connecting-to-github-with-ssh/generating-a-new-ssh-key-and-adding-it-to-the-ssh-agent) on how to do it.
...
Now you have your projecto on a folder on your computer and you can work on it as if it was any normal folder.
...
Tells you the current state of the repository. On a folder with uncomited changes it will say something like:
