...
Python follows community standards defined in PEPs ([Python Enhancement Proposals](https://peps.python.org/pep-0000/)). [PEP 8](https://peps.python.org/pep-0008/), for example, specifies how code should be styled (indentation, line length, naming conventions, etc.).
...
As a summary, is a tool that formats the code according to the python standard. For this course, we’ll use [Ruff](https://github.com/astral-sh/ruff) as a linter because:
